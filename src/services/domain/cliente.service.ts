...
export class ClienteService {
    ...
    constructor(public http: HttpClient, public storage: StorageService, public imgService: ImageUtilService){
    }
    ...
    uploadPicture(picture){
        let pictureBlob = this.imgService.dataUriToBlob(picture);
